...
$(document).ready(function() {
    ...
    /* var wooddie_input = document.getElementById('wooddie').value;
    var wooddie_array = $.parseJSON(wooddie_input);
    const woodDiaPrice = wooddie_array;
    console.log(woodDiaPrice);

    var woodworkhalfperi_input = document.getElementById('woodworkhalfperi').value;
    var woodworkhalfperi_array = $.parseJSON(woodworkhalfperi_input);
    const woodWorkHalfPeri = woodworkhalfperi_array;
    console.log(woodWorkHalfPeri);
    ...
    const woodworksemiperi = woodworksemiperi_array;
    console.log(woodworksemiperi); */
});
...
$('#total_amount_old').on('submit', function(e)
{
    var wooddie_input = document.getElementById('wooddie').value;
    var wooddie_array = $.parseJSON(wooddie_input);
    const woodDiaPrice = wooddie_array;
